    ...
    if(isLoading === true){
      ...
      for(let i = 0; i< projects.length; i++){
        ...
        dataTableValue.push({
          ...
          projectimage:projects[i].projectimage ? <img src={"/images/"+projects[i].projectimage} alt="Project screen" width="100"></img> : <img src="/images/default.png" alt="Default screen" width="100"></img>,
          ...
          action:<div><a href={"./project/edit/"+projects[i]._id} className="trash"><MDBIcon icon="pen-alt" /></a> | 
          <a onClick={() => this.deleteproject(projects[i]._id)} className="trash"><MDBIcon far icon="trash-alt" /></a></div>
        });
      }
    }
