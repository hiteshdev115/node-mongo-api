        ...
        if(logoimage === ''){
            ...
            imageDisp.push(
                <div key="imagecontain">
                    <img src={"/images/"+logoimage} width="200" alt={logoimage} title={logoimage}></img>
                    <input type="hidden" name="file" value={logoimage} />
                    <br/>
                    <a className="genric-btn default-border circle" onClick={this.unlinkLogo}>Remove Logo</a>
                </div>
            )
        }
        return (
