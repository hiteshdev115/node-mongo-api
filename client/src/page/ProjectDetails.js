    ...
    return (
      <div>
        <MetaTags>
            ...
            <meta property="og:image" content={"/images/"+projectimage} />
                ...
                <div className="row d-flex align-items-center justify-content-center">
                    <div className="about-content col-lg-12">
                        <div className="feature-img">
                            <img className="img-fluid" src={"/images/"+projectimage} alt={category}></img>
                        </div>
                    </div>	
                </div>
            </div>
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            ...
                            <div className="screenshot">
                                <img src={"/images/"+projectimage} alt={category}></img>
                            </div>
                        </div>
                    </div>
                </div>
